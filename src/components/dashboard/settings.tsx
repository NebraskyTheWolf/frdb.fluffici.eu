                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label className="block text-sm font-medium text-gray-400">
                                Select the staff
                                roles {renderHelpIcon('Select roles that will have staff permissions.')}
                            </label>
                            <Select
                        ...
                        <div className="flex items-center justify-between">
                            <label className="block text-sm font-medium text-gray-400">
                                Select the channels where the filters will be
                                ignored {renderHelpIcon('These channels will be exempt from any filters applied.')}
                            </label>
                            <Select
                        ...
                        <div className="flex items-center justify-between">
                            <label className="block text-sm font-medium text-gray-400">
                                Select the roles that will be ignored with
                                filters {renderHelpIcon('Members with these roles will be exempt from any filters applied.')}
                            </label>
                            <Select
                                options={renderSelectOptions(roles)}
                                isMulti
